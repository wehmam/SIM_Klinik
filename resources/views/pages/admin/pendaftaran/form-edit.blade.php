...
@section('title','Edit Data Pendaftan')
...
<div class="content-header">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Pendaftaran Pasien ke poli</h1>
        </div>
        <div class="col-sm-6">
                        ...
                        <div class="col">
                            ...
                            <select name="id_dokter" id="id_dokter" class="form-control">
                                @foreach($dokter as $dokters)
                                    <option value="{{ $dokters->id }}" {{ $dokters->id === $pendaftaran->id_dokter ? 'selected' : '' }}>{{ $dokters->spesialis . " - " . $dokters->dokter }} </option>
                                @endforeach
                            </select>
                            @error('id_dokter')
                                <div class="text-danger">{{ $message }}</div>
