            ...
            <div class="col-md-8 offset-1">
                <form action="{{ route('pendaftaran.update',$pendaftaran->no_pendaftaran) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_pasien" id="pasien" class="form-control @error('id_pasien') @enderror" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_dokter" id="dokter" class="form-control @error('id_dokter')is-invalid @enderror">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_poli" id="poli" class="form-control @error('id_poli') is-invalid @enderror">
